...
A token is used to authenticate users. It provides permissions and access when a login request is successful and matches a user to the application.

2. What steps can you take in your web apps to keep your data secure?

Web apps can provide server and client side authentication to increase data security.

3. Describe how web servers work.

Web servers use HTTP requests to provide data to browsers.
